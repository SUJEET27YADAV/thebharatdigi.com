  ...
  return (
    <main className="w-full flex flex-col items-center gap-4 p-10">
      ...
      <p>
        <h2>Introduction</h2>
        <p>
          This Privacy Policy describes how The Bharat Digital and its
          affiliates (collectively &quot;The Bharat Digital, we, our, us&quot;)
          collect, use, share, protect or otherwise process your information/
          personal data through our website www.thebharatdigi.com (hereinafter
        ...
        <p>
          ...
          receive an email, a call from a person/association claiming to be The
          Bharat Digital seeking any personal data like debit/credit card PIN,
