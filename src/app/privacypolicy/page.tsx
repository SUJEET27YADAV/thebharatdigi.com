...
export default function Page() {
  return (
    <main className="w-full max-w-7xl mx-auto pt-26 flex flex-col items-center gap-4 p-10">
      ...
      <p>
        This Privacy Policy describes how The Bharat Digital and its affiliates
        (collectively &quot;The Bharat Digital, we, our, us&quot;) collect, use,
        share, protect or otherwise process your information/ personal data
        through our website www.thebharatdigi.com (hereinafter referred to as
      ...
      <p>
        ...
        person/association claiming to be The Bharat Digital seeking any
        personal data like debit/credit card PIN, net-banking or mobile banking
        password, we request you to never provide such information. If you have
      ...
      <p>
        Data Deletion and Retention- You have an option to delete your account
      ...
      <p>
        Consent- By visiting our Platform or by providing your information, you
      ...
      <p>
        Cancellations will only be considered if the request is made 7 days of
      ...
      <p>
        The Bharat Digital does not accept cancellation requests for perishable
        items like flowers, eatables, etc. However, the refund / replacement can
      ...
      <p>
        ...
        its own end. This should be reported within 7 days of receipt of
