...
export default function LocationsPage() {
  return (
    <>
      ...
      <section className="relative py-16 md:py-20 overflow-hidden bg-white dark:bg-slate-900">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-slate-900 dark:text-white">
            <span className="gradient-text">Web Development</span> Across Delhi
            NCR
          </h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-slate-600 dark:text-gray-400 mb-10 leading-relaxed">
            ...
            region — from Delhi&apos;s corporate hubs to Noida&apos;s tech corridor and
            Gurugram&apos;s startup ecosystem.
          </p>
        </div>
      </section>
