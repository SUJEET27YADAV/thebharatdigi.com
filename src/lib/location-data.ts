...
export const locations: CityPageData[] = [
  {
    ...
    city: "Delhi",
    subtitle:
      "Delhi-based web development company building high-performance websites and digital platforms for businesses across the capital.",
    description:
  ...
  },
  {
    ...
    city: "Noida",
    subtitle:
      "Noida-based web development company delivering modern, scalable websites and web applications for businesses in Sector 62, Sector 63, and across the city.",
    description:
  ...
  },
  {
    ...
    city: "Gurugram",
    subtitle:
      "Gurugram web development company building modern digital products for startups, SaaS companies, and enterprises in the Millennium City.",
    description:
  ...
  },
  {
    ...
    city: "Faridabad",
    subtitle:
      "Faridabad web development company offering affordable, high-quality websites and custom web applications for local businesses.",
    description:
  ...
  },
  {
    ...
    city: "Ghaziabad",
    subtitle:
      "Ghaziabad web development company delivering professional websites and digital solutions for local businesses, retailers, and service providers.",
    description:
...
export function getLocationBySlug(slug: string): CityPageData | undefined {
