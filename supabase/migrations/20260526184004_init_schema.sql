...
CREATE TABLE IF NOT EXISTS public.payments (
  ...
  CONSTRAINT payments_customer_id_customers_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS public.products (
  id text NOT NULL DEFAULT gen_random_uuid(),
  serial integer GENERATED BY DEFAULT AS IDENTITY UNIQUE NOT NULL,
  image_url text,
  name character varying NOT NULL,
